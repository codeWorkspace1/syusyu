...
- **DataTables**: 상품조회 데이터 테이블 플러그인으로 사용
- **Summernote**: 텍스트 편집기
...
- **폴더 구조**: 프로젝트 폴더 구조를 체계적으로 설계하여 팀원들이 각자의 작업 영역을 쉽게 파악하고 효율적으로 작업을 진행할 수 있도록 했습니다.
- **경로 최적화**: ViewPath 클래스를 사용하여 개발 과정에서 경로를 최적화하고, 이를 통해 애플리케이션의 성능과 유지보수성을 향상시켰습니다.
- **Git 커밋 메시지 컨벤션 도입**: 팀원들이 각자의 작업 내역을 쉽게 이해하고 과거의 변경 사항을 편리하게 추적할 수 있도록 했습니다. 이를 통해 협업 효율성과 코드 관리의 일관성을 높였습니다.
- **MySQL 함수 재사용**
...
<br><br><br> 
### 게시판
- **Summernote**: 공지사항 플러그인을 이용해서 텍스트 편집기를 사용했습니다.
